...
import com.yxkj.common.db.DynamicDataSource;
...
public class DruidConfiguration {
	 ...
	 * mysql
	 * */
	@Value(value="${spring.datasource.mysql.driverClassName}")
    ...
    public DynamicDataSource DruidDataSource() {
		...
		targetDataSourceMap.put("mysql", mysqlDataSource);
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("druidDataSource") DataSource dynamicDataSource)
            throws Exception {
